...
/* Module Version: 5.7 */
/* D:\Program Files\lscc\diamond\3.10_x64\ispfpga\bin\nt64\scuba.exe -w -n dds_pll -lang verilog -synth lse -arch xo2c00 -type pll -fin 12 -fclkop 120 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1  */
/* Thu Feb 24 17:14:00 2022 */


`timescale 1 ns / 1 ps
module dds_pll (CLKI, CLKOP)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
