...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, OLED_DC_Pin|OLED_RESET_Pin|OLED_CLK_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(OLED_DIN_GPIO_Port, OLED_DIN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : OLED_DC_Pin OLED_RESET_Pin OLED_CLK_Pin */
  GPIO_InitStruct.Pin = OLED_DC_Pin|OLED_RESET_Pin|OLED_CLK_Pin;
